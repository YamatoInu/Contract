...
contract YamatoInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 1e9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Yamato Inu";
    ...
    address public advertisementWallet =
        0x7D642fd9371cD03CdA37a7BB861E24719D480073;
    ...
    function antibot(
        ...
        require(
            ...
            "Mismatch between address and bot count"
        );
        ...
        require(this.balanceOf(from) >= bot, "Not enough bots");
